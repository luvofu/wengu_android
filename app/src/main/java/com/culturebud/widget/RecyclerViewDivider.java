...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    private Drawable verticalDivider, horizontalDivider;
    ...
    public void setDividerColor(int color) {
        mDivider.setColorFilter(color, PorterDuff.Mode.CLEAR);
    }

    public void setVerticalDrawable(Drawable divider) {
        verticalDivider = divider;
    }

    public void setHorizontalDrawable(Drawable divider) {
     ...
     */
    public RecyclerViewDivider(Context context, int orientation, int dividerHeight, @ColorInt int dividerColor) {
        this(context, orientation);
