...
public class MultipleStatusView extends RelativeLayout {
    ...
    public void showLoading(boolean showContent) {
        ...
        showViewByStatus(mViewStatus, showContent);
    }
    ...
    public final void showContent() {
        ...
        showViewByStatus(mViewStatus, true);
    }

    private void showViewByStatus(int viewStatus, boolean showContent) {
        if (null != mLoadingView) {
        ...
        if (null != mContentView) {
            mContentView.setVisibility(showContent ? View.VISIBLE : View.GONE);
        }
    }

    public void hiddenStatusView() {
        if (null != mLoadingView) {
        ...
        if (null != mContentView && mContentView.getVisibility() != View.VISIBLE) {
